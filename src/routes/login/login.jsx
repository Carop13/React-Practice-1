        ...
        <form autoComplete='new-password' onSubmit={this.submitForm}>
          <Card theme={styles}>
            <CardText>
              ...
              <Input type='text' label='Username' name='login' value={this.state.login} onChange={this.handleChange.bind(this, 'login')} theme={styles} />
            ...
            <CardActions theme={styles}>
              <Button className={styles.chancho} label="Login" type="submit"/>
            </CardActions>
          </Card>
        </form>
      </div>
